...
\section{Centroid in Wasserstein Space}

    I found the centroid in Wasserstein space and plotted it for the MNIST dataset and a few univariate Gaussians. (I used the \href[]{https://pythonot.github.io/index.html}{Python Optimal Transport} library to do so.)

    \subsection{MNIST}

        Finding the centroid in Wasserstein space for each digit in the MNIST dataset.
